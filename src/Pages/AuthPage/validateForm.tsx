  ...
  if (path === '/register') {
    ...
    const zipCheck = (zip: string) => {
      ...
      if (zip === '') {
        ...
        values.country_ship === 'GB' &&
        zip &&
        !zipPatternGB.test(zip)
      ) {
        ...
        values.country_ship === 'BE' &&
        zip &&
        !zipPatternBe.test(zip)
      ) {
        errorMsg = 'Postal code format must be 9999'
      } else if (
        values.country_ship === 'NL' &&
        zip &&
        !zipPatternNl.test(zip)
      ) {
    ...
    if (!values.billingisthesame) {
      ...
      if (values.street_bill === '') {
        ...
        values.street_bill &&
        !streetPattern.test(values.street_bill)
      ) {
